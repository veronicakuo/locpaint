...
class EvaluationModel:
    ...
    def inpaint(self, images, masks):
        ...
        Returns:
            ...
            reconstructed: Raw decoder output
            completed: Final completed images
        """
        ...
        # Complete the image
        completed = images * (1 - masks) + reconstructed * masks
        
        return masked_images, reconstructed, completed
...
def evaluate(args):
    ...
    # Override mask settings if specified
    if args.mask_type:
